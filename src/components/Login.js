...
const Login = () => {
  ...
  const handleButtonClick = () => {
    ...
    // Message is null then write sign up or sign in logic
  ...
  return (
    <div>
      ...
      <form
        ...
        className="w-3/12 absolute p-12 bg-black my-32 mx-auto left-0 right-0 text-white rounded-md opacity-85"
      >
        ...
        <button
          className="p-2 mt-4 bg-red-600 rounded-md w-full"
